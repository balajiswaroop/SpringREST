 ...
 */
public class SpringHttpMessageConvertersIntegrationTestCase {
	...
	@Test
	public void givenConsumingXmlwhenreadingTheFoo_thenCorrect(){
		final String URI = BASE_URI + "foos/{id}";
	...
	@Test
	public void givenConsumingJSONwhenreadingTheFoo_thenCorrect(){
		final String URI = BASE_URI + "foos/{id}";
